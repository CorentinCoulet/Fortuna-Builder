...
export const EliotropeSpells = {
    active: {
        1: { src: EliotropeActive1, alt: 'Coalition' },
        2: { src: EliotropeActive2, alt: 'Empreinte de Wakfu' },
        3: { src: EliotropeActive3, alt: 'Brèche temporaire' },
        4: { src: EliotropeActive4, alt: 'Exode' },
        5: { src: EliotropeActive5, alt: 'Incandescence' },
        6: { src: EliotropeActive6, alt: 'Barrière' },
    },
    earth: {
        1: { src: EliotropeEarth1, alt: 'Targe fracassante' },
        2: { src: EliotropeEarth2, alt: 'Egide ardente' },
        3: { src: EliotropeEarth3, alt: 'Séisme' },
        4: { src: EliotropeEarth4, alt: 'Heurt' },
        5: { src: EliotropeEarth5, alt: 'Raclée' },
    },
    passive: {
        1: { src: EliotropePassive1, alt: 'Résilience' },
        2: { src: EliotropePassive2, alt: 'Traquenard' },
        3: { src: EliotropePassive3, alt: 'Intermédiaire' },
        4: { src: EliotropePassive4, alt: 'Rage' },
        5: { src: EliotropePassive5, alt: 'Transitoire' },
        6: { src: EliotropePassive6, alt: 'Effervescence' },
        7: { src: EliotropePassive7, alt: 'Portail céleste' },
        8: { src: EliotropePassive8, alt: 'Disciple du portail' },
        9: { src: EliotropePassive9, alt: 'Réminiscence' },
        10: { src: EliotropePassive10, alt: 'Interstellaire' },
        11: { src: EliotropePassive11, alt: 'Dimension blanche' },
        12: { src: EliotropePassive12, alt: 'Quiétude' },
        13: { src: EliotropePassive13, alt: 'Espace-temps' },
        14: { src: EliotropePassive14, alt: 'Porta(i)l' },
        15: { src: EliotropePassive15, alt: 'Bouclier de la fin' },
        16: { src: EliotropePassive16, alt: 'Épée du début' },
        17: { src: EliotropePassive17, alt: 'Cicatrisation' },
        18: { src: EliotropePassive18, alt: 'Concentration' },
        19: { src: EliotropePassive19, alt: 'Système lunaire' },
        20: { src: EliotropePassive20, alt: 'Souffle de la déesse' },
    },
    water: {
        1: { src: EliotropeWater1, alt: 'Wakméha' },
        2: { src: EliotropeWater2, alt: 'Pulsation' },
        3: { src: EliotropeWater3, alt: 'Déluge' },
        4: { src: EliotropeWater4, alt: 'Tourbillon' },
        5: { src: EliotropeWater5, alt: 'Cataclysme' },
    },
    wind: {
        1: { src: EliotropeWind1, alt: 'Flux torrenciel' },
        2: { src: EliotropeWind2, alt: 'Siphon' },
        3: { src: EliotropeWind3, alt: 'Salve éthérée' },
        4: { src: EliotropeWind4, alt: 'Tempête' },
        5: { src: EliotropeWind5, alt: 'Lame déchaînée' },
    },
};
// Eniripsa
...
export const FecaSpells = {
    active: {
        1: { src: FecaActive1, alt: 'Immunité' },
        2: { src: FecaActive2, alt: 'Trêve' },
        3: { src: FecaActive3, alt: 'Pacification' },
        4: { src: FecaActive4, alt: 'Provocation' },
        5: { src: FecaActive5, alt: 'Égide' },
        6: { src: FecaActive6, alt: 'Magnétisme' },
    },
    earth: {
        1: { src: FecaEarth1, alt: 'Frappe tellurique' },
        2: { src: FecaEarth2, alt: 'Orbe défensif' },
        3: { src: FecaEarth3, alt: 'Bastion' },
        4: { src: FecaEarth4, alt: 'Rempart' },
        5: { src: FecaEarth5, alt: 'Bâton' },
    },
    fire: {
        1: { src: FecaFire1, alt: 'Fécalistofedes' },
        2: { src: FecaFire2, alt: 'Météorite' },
        3: { src: FecaFire3, alt: 'Attaque naturelle' },
        4: { src: FecaFire4, alt: 'Magma' },
        5: { src: FecaFire5, alt: 'Volcan' },
    },
    passive: {
        1: { src: FecaPassive1, alt: 'Glyphe augmenté' },
        2: { src: FecaPassive2, alt: 'Ligne' },
        3: { src: FecaPassive3, alt: 'Un pour tous' },
        4: { src: FecaPassive4, alt: 'Maître des boucliers' },
        5: { src: FecaPassive5, alt: 'Qui veut la paix prépare la guerre' },
        6: { src: FecaPassive6, alt: 'Marché pacifiste' },
        7: { src: FecaPassive7, alt: 'Connaissance de la carte' },
        8: { src: FecaPassive8, alt: 'La meilleure défense est \'attaque' },
        9: { src: FecaPassive9, alt: 'Armure de combat' },
        10: { src: FecaPassive10, alt: 'Peau rocheuse' },
        11: { src: FecaPassive11, alt: 'Oeil pour oeil' },
        12: { src: FecaPassive12, alt: 'Glyphes persistants' },
        13: { src: FecaPassive13, alt: 'Berger' },
        14: { src: FecaPassive14, alt: 'Expérience du terrain' },
        15: { src: FecaPassive15, alt: 'Boucliers élémentaires' },
        16: { src: FecaPassive16, alt: 'Carapace d\'épines' },
        17: { src: FecaPassive17, alt: 'Compréhensible du Wakfu' },
        18: { src: FecaPassive18, alt: 'Protecteur du troupeau' },
    },
    water: {
        1: { src: FecaWater1, alt: 'Goutte' },
        2: { src: FecaWater2, alt: 'Onde' },
        3: { src: FecaWater3, alt: 'Avalanche' },
        4: { src: FecaWater4, alt: 'Orage' },
        5: { src: FecaWater5, alt: 'Lame de fond' },
    },
};
// Huppermage
...
export const IopSpells = {
    active: {
        1: { src: IopActive1, alt: 'Bond' },
        2: { src: IopActive2, alt: 'Posture de Défense' },
        3: { src: IopActive3, alt: 'Etendard de Bravoure' },
        4: { src: IopActive4, alt: 'Focus' },
        5: { src: IopActive5, alt: 'Heure de Gloire' },
        6: { src: IopActive6, alt: 'Amplification' },
    },
    earth: {
        1: { src: IopEarth1, alt: 'Ebranler' },
        2: { src: IopEarth2, alt: 'Roknocerok' },
        3: { src: IopEarth3, alt: 'Impact' },
        4: { src: IopEarth4, alt: 'Charge' },
        5: { src: IopEarth5, alt: 'Ravage' },
    },
    fire: {
        1: { src: IopFire1, alt: 'Fulgur' },
        2: { src: IopFire2, alt: 'Epée Céleste' },
        3: { src: IopFire3, alt: 'Super Iop Punch' },
        4: { src: IopFire4, alt: 'Epée du Jugement' },
        5: { src: IopFire5, alt: 'Colère de Iop' },
    },
    passive: {
        1: { src: IopPassive1, alt: 'Virilité' },
        2: { src: IopPassive2, alt: 'Autorité' },
        3: { src: IopPassive3, alt: 'Démonstration' },
        4: { src: IopPassive4, alt: 'Expert Tacleur' },
        5: { src: IopPassive5, alt: 'Roi de la Colline' },
        6: { src: IopPassive6, alt: 'Démonstration' },
        7: { src: IopPassive7, alt: 'Charge Furieuse' },
        8: { src: IopPassive8, alt: 'Faille Sismique' },
        9: { src: IopPassive9, alt: 'Bravoure' },
        10: { src: IopPassive10, alt: 'Persécuteur' },
    },
    wind: {
        1: { src: IopWind1, alt: 'Jabs' },
        2: { src: IopWind2, alt: 'Rafale' },
        3: { src: IopWind3, alt: 'Torgnole' },
        4: { src: IopWind4, alt: 'Eventrail' },
        5: { src: IopWind5, alt: 'Uppercut' },
    },
};
// Osamodas manquant
...
export const OsamodasSpells = {
    active: {
        1: { src: OsamodasActive1, alt: 'Dernier souffle' },
        2: { src: OsamodasActive2, alt: 'Piqure' },
        3: { src: OsamodasActive3, alt: 'Célérité' },
        4: { src: OsamodasActive4, alt: 'Cri affaiblissant' },
        5: { src: OsamodasActive5, alt: 'Relais' },
        6: { src: OsamodasActive6, alt: 'Lien animal' },
    },
    earth: {
        1: { src: OsamodasEarth1, alt: 'Tempête de sable' },
        2: { src: OsamodasEarth2, alt: 'Pesanteur' },
        3: { src: OsamodasEarth3, alt: 'Empalement' },
        4: { src: OsamodasEarth4, alt: 'Gambade' },
        5: { src: OsamodasEarth5, alt: 'Frappe du craqueleur' },
    },
    fire: {
        1: { src: OsamodasFire1, alt: 'Corbeau incendiaire' },
        2: { src: OsamodasFire2, alt: 'Fouet enflammé' },
        3: { src: OsamodasFire3, alt: 'Tornade de flammes' },
        4: { src: OsamodasFire4, alt: 'Attisement' },
        5: { src: OsamodasFire5, alt: 'Souffle du dragon' },
    },
    passive: {
        1: { src: OsamodasPassive1, alt: 'Rage du Mulou' },
        2: { src: OsamodasPassive2, alt: 'Don animal' },
        3: { src: OsamodasPassive3, alt: 'Vision du corbac' },
        4: { src: OsamodasPassive4, alt: 'Guerrier invocateur' },
        5: { src: OsamodasPassive5, alt: 'Invocateur solitaire' },
        6: { src: OsamodasPassive6, alt: 'Puissance draconique' },
        7: { src: OsamodasPassive7, alt: 'Esprit du phénix' },
        8: { src: OsamodasPassive8, alt: 'Force-taure' },
        9: { src: OsamodasPassive9, alt: 'Synergie animale' },
        10: { src: OsamodasPassive10, alt: 'Symbiose' },
        11: { src: OsamodasPassive11, alt: 'Transcendance draconique' },
        12: { src: OsamodasPassive12, alt: 'Étoile du Sud' },
        13: { src: OsamodasPassive13, alt: 'Sacrifice animal' },
        14: { src: OsamodasPassive14, alt: 'Étoile de l\'Est' },
        15: { src: OsamodasPassive15, alt: 'Dévouement animal' },
        16: { src: OsamodasPassive16, alt: 'Art du dressage' },
        17: { src: OsamodasPassive17, alt: 'Partage animal' },
    },
    wind: {
        1: { src: OsamodasWind1, alt: 'Fouet' },
        2: { src: OsamodasWind2, alt: 'Déplumage' },
        3: { src: OsamodasWind3, alt: 'Transfert' },
        4: { src: OsamodasWind4, alt: 'Souffle répulsif' },
        5: { src: OsamodasWind5, alt: 'Tornade de plumes' },
    },
};
// Ouginak manquant
...
export const OuginakSpells = {
    active: {
        1: { src: OuginakActive1, alt: 'Chasseur' },
        2: { src: OuginakActive2, alt: 'Élan' },
        3: { src: OuginakActive3, alt: 'Canine' },
        4: { src: OuginakActive4, alt: 'Apaisement' },
        5: { src: OuginakActive5, alt: 'Poursuite' },
        6: { src: OuginakActive6, alt: 'Meute' },
    },
    earth: {
        1: { src: OuginakEarth1, alt: 'Croc-en-jambe' },
        2: { src: OuginakEarth2, alt: 'Bastonnade' },
        3: { src: OuginakEarth3, alt: 'Molosse' },
        4: { src: OuginakEarth4, alt: 'Hachure' },
        5: { src: OuginakEarth5, alt: 'Saccade' },
    },
    passive: {
        1: { src: OuginakPassive1, alt: 'Compagnon' },
        2: { src: OuginakPassive2, alt: 'Marchandage' },
        3: { src: OuginakPassive3, alt: 'Canin\'Os' },
        4: { src: OuginakPassive4, alt: 'Acharné' },
        5: { src: OuginakPassive5, alt: 'Chasse ouverte' },
        6: { src: OuginakPassive6, alt: 'Digestion' },
        7: { src: OuginakPassive7, alt: 'Énergie Canine' },
        8: { src: OuginakPassive8, alt: 'Ardeur' },
        9: { src: OuginakPassive9, alt: 'Pillage' },
        10: { src: OuginakPassive10, alt: 'Fureur' },
        11: { src: OuginakPassive11, alt: 'Epuisement' },
        12: { src: OuginakPassive12, alt: 'Pistage' },
        13: { src: OuginakPassive13, alt: 'Flair' },
        14: { src: OuginakPassive14, alt: 'Art Canin' },
        15: { src: OuginakPassive15, alt: 'Terrier' },
        16: { src: OuginakPassive16, alt: 'Crocs Futés' },
        17: { src: OuginakPassive17, alt: 'Traqueur Canin' },
        18: { src: OuginakPassive18, alt: 'Force sage' },
        19: { src: OuginakPassive19, alt: 'Maître Chien' },
    },
    water: {
        1: { src: OuginakWater1, alt: 'Emeute' },
        2: { src: OuginakWater2, alt: 'Fléau' },
        3: { src: OuginakWater3, alt: 'Rupture' },
        4: { src: OuginakWater4, alt: 'Plombage' },
        5: { src: OuginakWater5, alt: 'Balafre' },
    },
    wind: {
        1: { src: OuginakWind1, alt: 'Balayage' },
        2: { src: OuginakWind2, alt: 'Contusion' },
        3: { src: OuginakWind3, alt: 'Cador' },
        4: { src: OuginakWind4, alt: 'Brise\'Os' },
        5: { src: OuginakWind5, alt: 'Baroud' },
    },
};
// Pandawa manquant
...
export const PandawaSpells = {
    active: {
        1: { src: PandawaActive1, alt: 'Tonneau' },
        2: { src: PandawaActive2, alt: 'Soif' },
        3: { src: PandawaActive3, alt: 'Happy Hour' },
        4: { src: PandawaActive4, alt: 'Ether' },
        5: { src: PandawaActive5, alt: 'Téléportono' },
        6: { src: PandawaActive6, alt: 'Ebriété' },
    },
    earth: {
        1: { src: PandawaEarth1, alt: 'Triple Karma Leet' },
        2: { src: PandawaEarth2, alt: 'Six Roses' },
        3: { src: PandawaEarth3, alt: 'Frappe Fût' },
        4: { src: PandawaEarth4, alt: 'Lucha L\'ambrée' },
        5: { src: PandawaEarth5, alt: 'Blitzkriek' },
    },
    fire: {
        1: { src: PandawaFire1, alt: 'Souffle Enflammé' },
        2: { src: PandawaFire2, alt: 'Tournée Générale' },
        3: { src: PandawaFire3, alt: 'Coup Laiteux' },
        4: { src: PandawaFire4, alt: 'Flasque Explosive' },
        5: { src: PandawaFire5, alt: 'Toilaitage' },
    },
    passive: {
        1: { src: PandawaPassive1, alt: 'Cocktail' },
        2: { src: PandawaPassive2, alt: 'Maître de l\'Ivresse' },
        3: { src: PandawaPassive3, alt: 'Tonneau sans Fond' },
        4: { src: PandawaPassive4, alt: 'Tonneau Agressif' },
        5: { src: PandawaPassive5, alt: 'Instinct Laiteux' },
        6: { src: PandawaPassive6, alt: 'Bambouteille' },
        7: { src: PandawaPassive7, alt: 'Cyanose' },
        8: { src: PandawaPassive8, alt: 'Buvette' },
        9: { src: PandawaPassive9, alt: 'Pandémie' },
        10: { src: PandawaPassive10, alt: 'Éméché' },
    },
    water: {
        1: { src: PandawaWater1, alt: 'Souffle Laiteux' },
        2: { src: PandawaWater2, alt: 'Nuage Laiteux' },
        3: { src: PandawaWater3, alt: 'Tekilait' },
        4: { src: PandawaWater4, alt: 'Vague de Lait' },
        5: { src: PandawaWater5, alt: 'Fontaine de Laiqueur' },
    },
};
// Roublard manquant FF
...
export const RoublardSpells = {
    active: {
        1: { src: RoublardActive1, alt: 'Botte' },
        2: { src: RoublardActive2, alt: 'Fumigènes' },
        3: { src: RoublardActive3, alt: 'Grappin' },
        4: { src: RoublardActive4, alt: 'Evanescence' },
        5: { src: RoublardActive5, alt: 'Aimant' },
        6: { src: RoublardActive6, alt: 'Défourailleur' },
    },
    earth: {
        1: { src: RoublardEarth1, alt: 'Mitraille' },
        2: { src: RoublardEarth2, alt: 'Troublon' },
        3: { src: RoublardEarth3, alt: 'Balle plombate' },
        4: { src: RoublardEarth4, alt: 'Dague boomerang' },
        5: { src: RoublardEarth5, alt: 'Pulsar' },
    },
    fire: {
        1: { src: RoublardFire1, alt: 'Barbrûlé' },
        2: { src: RoublardFire2, alt: 'Bombe collante' },
        3: { src: RoublardFire3, alt: 'Exécution' },
        4: { src: RoublardFire4, alt: 'Croisemennt' },
        5: { src: RoublardFire5, alt: 'Perforation' },
    },
    passive: {
        1: { src: RoublardPassive1, alt: 'Trainée de poudre' },
        2: { src: RoublardPassive2, alt: 'Roublaboom' },
        3: { src: RoublardPassive3, alt: 'Explobombe' },
        4: { src: RoublardPassive4, alt: 'Artificier' },
        5: { src: RoublardPassive5, alt: 'Fugitif' },
        6: { src: RoublardPassive6, alt: 'Maître des lames' },
        7: { src: RoublardPassive7, alt: 'Bombes élémentaires' },
        8: { src: RoublardPassive8, alt: 'Tunique renforcée' },
        9: { src: RoublardPassive9, alt: 'Bomber Fan' },
        10: { src: RoublardPassive10, alt: 'Tir surprise' },
        11: { src: RoublardPassive11, alt: 'Fuyard' },
        12: { src: RoublardPassive12, alt: 'Maître Roublard' },
        13: { src: RoublardPassive13, alt: 'Baril' },
        14: { src: RoublardPassive14, alt: 'Lame rouillée' },
        15: { src: RoublardPassive15, alt: 'Démineur' },
        16: { src: RoublardPassive16, alt: 'Mur de poudre' },
        17: { src: RoublardPassive17, alt: 'Dynamite' },
        18: { src: RoublardPassive18, alt: 'Jackpot' },
        19: { src: RoublardPassive19, alt: 'Tacticien' },
        20: { src: RoublardPassive20, alt: 'Bombes à retardement' },
    },
    wind: {
        1: { src: RoublardWind1, alt: 'Coup rapide' },
        2: { src: RoublardWind2, alt: 'Tricherie' },
        3: { src: RoublardWind3, alt: 'Espingole' },
        4: { src: RoublardWind4, alt: 'Longue lame' },
        5: { src: RoublardWind5, alt: 'Oblitération' },
    },
};
// Sacrieur 
...
export const SadidaSpells = {
    active: {
        1: { src: SadidaActive1, alt: 'Arbre' },
        2: { src: SadidaActive2, alt: 'Sacrifice Poupesque' },
        3: { src: SadidaActive3, alt: 'Eveil Sylvestre' },
        4: { src: SadidaActive4, alt: 'Fertilisant' },
        5: { src: SadidaActive5, alt: 'Force de la nature' },
        6: { src: SadidaActive6, alt: 'Toxines' },
    },
    earth: {
        1: { src: SadidaEarth1, alt: 'Ronce' },
        2: { src: SadidaEarth2, alt: 'Engrais' },
        3: { src: SadidaEarth3, alt: 'Herbes Folles' },
        4: { src: SadidaEarth4, alt: 'Tremblement de Terre' },
        5: { src: SadidaEarth5, alt: 'Ronces Multiples' },
    },
    passive: {
        1: { src: SadidaPassive1, alt: 'Prière Sadida' },
        2: { src: SadidaPassive2, alt: 'Croissance accélérée' },
        3: { src: SadidaPassive3, alt: 'Exploupée' },
        4: { src: SadidaPassive4, alt: 'Don sylvestre' },
        5: { src: SadidaPassive5, alt: 'Mauvaise graine' },
        6: { src: SadidaPassive6, alt: 'Dévouement poupesque' },
        7: { src: SadidaPassive7, alt: 'Sadida Solitaire' },
        8: { src: SadidaPassive8, alt: 'Terrain fertile' },
        9: { src: SadidaPassive9, alt: 'Lien Poupesque' },
        10: { src: SadidaPassive10, alt: 'Savoir Sadida' },
        11: { src: SadidaPassive11, alt: 'Cycle sylvestre' },
        12: { src: SadidaPassive12, alt: 'Venimeux' },
        13: { src: SadidaPassive13, alt: 'Terrain d\'entente' },
        14: { src: SadidaPassive14, alt: 'Chaîne de la nature' },
        15: { src: SadidaPassive15, alt: 'Poussée sylvestre' },
        16: { src: SadidaPassive16, alt: 'Cummunication végétale' },
        17: { src: SadidaPassive17, alt: 'Garde Feuille' },
        18: { src: SadidaPassive18, alt: 'Bénédiction Voodoll' },
        19: { src: SadidaPassive19, alt: 'Terrain infecté' },
        20: { src: SadidaPassive20, alt: 'Murmures Sauvages' },
    },
    water: {
        1: { src: SadidaWater1, alt: 'Vaporiser' },
        2: { src: SadidaWater2, alt: 'Larme du Sadida' },
        3: { src: SadidaWater3, alt: 'Gadoule' },
        4: { src: SadidaWater4, alt: 'Rouille' },
        5: { src: SadidaWater5, alt: 'Drainage' },
    },
    wind: {
        1: { src: SadidaWind1, alt: 'Relent Boisé' },
        2: { src: SadidaWind2, alt: 'Vent Empoisonné' },
        3: { src: SadidaWind3, alt: 'Coup de Froid' },
        4: { src: SadidaWind4, alt: 'Kohmir' },
        5: { src: SadidaWind5, alt: 'Bourrasque' },
    },
};
// Sram manquant
...
export const SramSpells = {
    active: {
        1: { src: SramActive1, alt: 'Invisibilité' },
        2: { src: SramActive2, alt: 'Double' },
        3: { src: SramActive3, alt: 'Ombre Piège' },
        4: { src: SramActive4, alt: 'Galopade' },
        5: { src: SramActive5, alt: 'Assassinat' },
        6: { src: SramActive6, alt: 'Surineur' },
    },
    fire: {
        1: { src: SramFire1, alt: 'Premier Sang' },
        2: { src: SramFire2, alt: 'Châtiment' },
        3: { src: SramFire3, alt: 'Ouvrir les veines' },
        4: { src: SramFire4, alt: 'Saignée mortelle' },
        5: { src: SramFire5, alt: 'Mise à mort' },
    },
    passive: {
        1: { src: SramPassive1, alt: 'Assassin' },
        2: { src: SramPassive2, alt: 'Lame Sanglante' },
        3: { src: SramPassive3, alt: 'Assaut Brutal' },
        4: { src: SramPassive4, alt: 'Maître des Ombres' },
        5: { src: SramPassive5, alt: 'Maître des Pièges' },
        6: { src: SramPassive6, alt: 'Plan Tordu' },
        7: { src: SramPassive7, alt: 'Embuscade' },
        8: { src: SramPassive8, alt: 'Escroquerie' },
        9: { src: SramPassive9, alt: 'Duperie' },
        10: { src: SramPassive10, alt: 'Sram dans l\'Âme' },
    },
    water: {
        1: { src: SramWater1, alt: 'Kleptosram' },
        2: { src: SramWater2, alt: 'Filouterie' },
        3: { src: SramWater3, alt: 'Attaque perfide' },
        4: { src: SramWater4, alt: 'Escrosramerie' },
        5: { src: SramWater5, alt: 'Arnaque' },
    },
    wind: {
        1: { src: SramWind1, alt: 'Coup pénétrant' },
        2: { src: SramWind2, alt: 'Peur' },
        3: { src: SramWind3, alt: 'Fourberie' },
        4: { src: SramWind4, alt: 'Coup Sournois' },
        5: { src: SramWind5, alt: 'Traumatisme' },
    },
};
// Streamer manquant
...
export const StreamerSpells = {
    active: {
        1: { src: StreamerActive1, alt: 'Blindage' },
        2: { src: StreamerActive2, alt: 'Surtension' },
        3: { src: StreamerActive3, alt: 'Machinerie' },
        4: { src: StreamerActive4, alt: 'Embuscade' },
        5: { src: StreamerActive5, alt: 'Transition' },
        6: { src: StreamerActive6, alt: 'Flux de Stasis' },
    },
    earth: {
        1: { src: StreamerEarth1, alt: 'À la masse' },
        2: { src: StreamerEarth2, alt: 'Piétinement' },
        3: { src: StreamerEarth3, alt: 'Pilonnage' },
        4: { src: StreamerEarth4, alt: 'Marteau aimant' },
        5: { src: StreamerEarth5, alt: 'Choc' },
    },
    fire: {
        1: { src: StreamerFire1, alt: 'Feu ardent' },
        2: { src: StreamerFire2, alt: 'Crache flammes' },
        3: { src: StreamerFire3, alt: 'Calcination' },
        4: { src: StreamerFire4, alt: 'Flambage' },
        5: { src: StreamerFire5, alt: 'Sabordage' },
    },
    passive: {
        1: { src: StreamerPassive1, alt: 'Modérateur' },
        2: { src: StreamerPassive2, alt: 'Routes sinueuses' },
        3: { src: StreamerPassive3, alt: 'Versatilité' },
        4: { src: StreamerPassive4, alt: 'Blindage renforcé' },
        5: { src: StreamerPassive5, alt: 'Stratégie robotique' },
        6: { src: StreamerPassive6, alt: 'Technologie de transports' },
        7: { src: StreamerPassive7, alt: 'Assitance tellurique' },
        8: { src: StreamerPassive8, alt: 'Substitution mécanique' },
        9: { src: StreamerPassive9, alt: 'Patience' },
        10: { src: StreamerPassive10, alt: 'Alliage léger' },
        11: { src: StreamerPassive11, alt: 'Transfert brutal' },
        12: { src: StreamerPassive12, alt: 'Revêtement à toute épreuve' },
        13: { src: StreamerPassive13, alt: 'Activation' },
        14: { src: StreamerPassive14, alt: 'Exécution immédiate' },
        15: { src: StreamerPassive15, alt: 'Protection stasifiée' },
        16: { src: StreamerPassive16, alt: 'Roues chaudes' },
        17: { src: StreamerPassive17, alt: 'Conquête sereine' },
        18: { src: StreamerPassive18, alt: 'Tacticien' },
        19: { src: StreamerPassive19, alt: 'Mécanique avancée' },
        20: { src: StreamerPassive20, alt: 'Commutation' },
    },
    water: {
        1: { src: StreamerWater1, alt: 'Courant' },
        2: { src: StreamerWater2, alt: 'Évaporation' },
        3: { src: StreamerWater3, alt: 'Ecume' },
        4: { src: StreamerWater4, alt: 'Flibuste' },
        5: { src: StreamerWater5, alt: 'Dissolution' },
    },
};
// Xelor manquant
...
export const XelorSpells = {
    active: {
        1: { src: XelorActive1, alt: 'Dévouement' },
        2: { src: XelorActive2, alt: 'Contre la montre' },
        3: { src: XelorActive3, alt: 'Sinistro' },
        4: { src: XelorActive4, alt: 'Rouage' },
        5: { src: XelorActive5, alt: 'Prémonition' },
        6: { src: XelorActive6, alt: 'Régulateur' },
    },
    fire: {
        1: { src: XelorFire1, alt: 'Perturbation' },
        2: { src: XelorFire2, alt: 'Suspension' },
        3: { src: XelorFire3, alt: 'Éclair obscur' },
        4: { src: XelorFire4, alt: 'Aiguille' },
        5: { src: XelorFire5, alt: 'Poussière' },
    },
    passive: {
        1: { src: XelorPassive1, alt: 'Maître du cadran' },
        2: { src: XelorPassive2, alt: 'Promptitude' },
        3: { src: XelorPassive3, alt: 'Présage' },
        4: { src: XelorPassive4, alt: 'Tique, Taque' },
        5: { src: XelorPassive5, alt: 'Taque, Tique' },
        6: { src: XelorPassive6, alt: 'Horlogerie' },
        7: { src: XelorPassive7, alt: 'Mémoire' },
        8: { src: XelorPassive8, alt: 'Cours du temps' },
        9: { src: XelorPassive9, alt: 'Contre-horaire' },
        10: { src: XelorPassive10, alt: 'Déjà vu' },
        11: { src: XelorPassive11, alt: 'Connaissance du passé' },
        12: { src: XelorPassive12, alt: 'Présages violents' },
        13: { src: XelorPassive13, alt: 'Dimension sombre' },
        14: { src: XelorPassive14, alt: 'Ralentissement du temps' },
        15: { src: XelorPassive15, alt: 'Rémanence' },
        16: { src: XelorPassive16, alt: 'Mécanismes spécialisés' },
        17: { src: XelorPassive17, alt: 'Permutation momentanée' },
        18: { src: XelorPassive18, alt: 'Mage de combat' },
        19: { src: XelorPassive19, alt: 'Flétrissement' },
        20: { src: XelorPassive20, alt: 'Assimilation' },
    },
    water: {
        1: { src: XelorWater1, alt: 'Martel-heure' },
        2: { src: XelorWater2, alt: 'Ralentissement' },
        3: { src: XelorWater3, alt: 'Horloge' },
        4: { src: XelorWater4, alt: 'Sablier' },
        5: { src: XelorWater5, alt: 'Désynchronisation' },
    },
    wind: {
        1: { src: XelorWind1, alt: 'Pointe-heure' },
        2: { src: XelorWind2, alt: 'Tempus fugit' },
        3: { src: XelorWind3, alt: 'Paradoxe' },
        4: { src: XelorWind4, alt: 'Symétrie' },
        5: { src: XelorWind5, alt: 'Retour spontané' },
    },
};
// Zobal 
